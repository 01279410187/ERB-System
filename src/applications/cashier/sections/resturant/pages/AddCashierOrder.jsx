...
//     // Validation function for tableNumber
...
//     // Validation function for customerName
...
//     // Validation function for discountReason
...
//         if (!validateForm()) {
//             // If form validation fails, return without submitting
//             return;
//         }
...
//                     {errors.tableNumber && <span className="error cashier-input-error">{errors.tableNumber}</span>} {/* Display error message */}
//                 </div>
//                 <div>
...
//                     {errors.customerName && <span className="error cashier-input-error">{errors.customerName}</span>} {/* Display error message */}
//                 </div>
//                 <div>
...
//                     {errors.discount && <span className="error cashier-input-error">{errors.discount}</span>} {/* Display error message */}
//                 </div>
//                 <div>
...
//                     {errors.discountReason && <span className="error cashier-input-error">{errors.discountReason}</span>} {/* Display error message */}
//                 </div>
//                 {/* <div>
