...
function PrintInvoice() {
    ...
    const generatePDF = () => {
        ...
        {
            data.invoiceType === "in_coming" ? html2pdf()
                .from(element)
                .save(`${data.supplier + "-" + data.code + "-" + "فاتورة مورد"}.pdf`) : data.invoiceType === "out_going" ? html2pdf()
                    .from(element)
                    .save(`${data.to + "-" + data.code + "-" + "اذن صرف"} .pdf`) : html2pdf()
                        .from(element)
        ...
        <main>
            <div id="invoice-container" >
                <div className="headers-wrapper">
                    {data.status === "approved" && <div className="status-green" >
                        <p>تم المراجعة</p>
                    </div>}
                    {data.status === "rejected" && <div className="status-red" >
                        <p>تم الرفض</p>
                    </div>}
                    {data.status === "done" && <div className="status-black" >
                        <p> تم الصرف</p>
                    </div>}
                    {data.status === "pending" && <div className="status-yellow" >
                        <p> تحت المراجعة</p>
                    </div>}
                    {
                        data.invoiceType === "in_coming" && <div className="main-title">
                            <p>فاتورة مورد </p>
                        </div>
                    }
                    {
                        data.invoiceType === "out_going" && <div className="main-title">
                            <p> إذن صرف </p>
                        </div>
                    }
                    {
                        data.invoiceType === "returned" && <div className="main-title">
                            <p> فاتورة مرتجع </p>
                        </div>
                    }
                ...
                <div className="invoice-items">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <td className="text-center">العنصر 1</td>
                            <td className="text-center">10</td>
                            <td className="text-right">2</td>
                            <td className="text-right">1 يونيو 2024</td>
                            <td className="text-right">20</td>
                        </tr>
                        <tr>
                            <td className="text-center">2</td>
                            <td className="text-center">العنصر 2</td>
                            <td className="text-center">15</td>
                            <td className="text-right">1</td>
                            <td className="text-right">1 يوليو 2024</td>
            ...
            <div style={{ display: "flex", justifyContent: "center" }}>
                <button onClick={generatePDF} className="pdf-button" > حفظ PDF</button>
            </div>
